...
//banana slider
var BananaSlider = document.getElementById("BananaSlider");
var BananaOutput = document.getElementById("BananaValue");
var BananOutputVarNo = document.getElementById("BananaOutputVar");

let updateBanana = () => BananaOutput.innerHTML = BananaSlider.value* 100;
BananaSlider.addEventListener('input', updateBanana);
updateBanana();

//apple slider
var AppleSlider = document.getElementById("AppleSlider");
var AppleOutput = document.getElementById("AppleValue");
var AppleOutputVarNo = document.getElementById("AppleOutputVar");

let updateApple = () => AppleOutput.innerHTML = AppleSlider.value* 100;
AppleSlider.addEventListener('input', updateApple);
updateApple();

//orange slider
var OrangeSlider = document.getElementById("OrangeSlider");
var OrangeOutput = document.getElementById("OrangeValue");
var OrangeOutputVarNo = document.getElementById("OrangeOutputVar");

let updateOrange = () => OrangeOutput.innerHTML = OrangeSlider.value* 100;
OrangeSlider.addEventListener('input', updateOrange);
updateOrange();
...
function predictWebcam() {
  ...
  model.detect(video).then(function (predictions) {
   ...
   /*     p.innerText = predictions[n].class  + ' - with ' 
    ...
    //} 
    if (predictions[n].score > PlantSlider.value && predictions[n].class=='potted plant') {
   ...
   else if (predictions[n].score > BananaSlider.value && predictions[n].class=='banana')
       {
     //   document.body.style.backgroundColor = "yellow";
     document.getElementById('BananaSliderDiv').style.color = "yellow"; 
      audioElementHigh.play();
     // setTimeout("audioElementMid.play()", 200);
    
  
      
      } /*else if ( predictions[0].class=='banana'
      && predictions[1].class=='banana' && predictions[0].score > BananaSlider.value && predictions[1].score > BananaSlider.value)
      {  
        audioElementSleeping.play();
        audioElementHigh.play();
//setTimeout("audioElementSleeping.play()", 200);
console.log("i see two bananas!");
   } */
