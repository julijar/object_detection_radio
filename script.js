...
function predictWebcam() {
  ...
  model.detect(video).then(function (predictions) {
   ...
   /*     p.innerText = predictions[n].class  + ' - with ' 
    ...
    //} 
    if (predictions[n].score > slider.value && predictions[n].class=='potted plant') {
     // document.body.style.backgroundColor = "green";
      audioElementLow.play();
    /*  this.dataset.playing = 'true'; */
    }
     else if (predictions[n].score > slider.value && predictions[n].class=='orange') {
    //    document.body.style.backgroundColor = "orange";
        audioElementMid.play();
     }
     else if (predictions[n].score > slider.value && predictions[n].class=='apple')
     {
    //  document.body.style.backgroundColor = "red";
      audioElementHigh.play();
   }
      else if (predictions[n].score > slider.value && predictions[n].class=='banana' )
       {
